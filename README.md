...
To Create a new template one simply has to layer Stacks and place objects within to display information and provide structure (Texts, Boxes, and Lines). One can create an entire resume now with like 30-40 lines of simple code. Go to the [Testing Script](testing_templates.py) to see. This gives the [partial result](Testing%20Results/testing_template_version.pdf) which is pratically identical to the results thus far (some of the margins are a few pixels off).
